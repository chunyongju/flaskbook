...
#login_required, current_user를 import한다
...
# UploadImageForm, DetectorForm, DeleteForm을 import한다
...
def detect(image_id):
    ...
    # 물체 감지를 실행하여 태그와 변환 수의 이미지 경로를 가져온다
...
def search():
    ...
    for user_image in user_images:
        ...
        # 추출 결과의 user_images 정보를 배열 설정한다
